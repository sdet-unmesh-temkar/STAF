...
public class TestRunner {
    static{
        if(System.getProperty("os.name").contains("Windows"))
            System.setProperty("logback.configurationFile",System.getProperty("user.dir")+"\\src\\test\\resources\\logback.xml");
        else
            System.setProperty("logback.configurationFile", System.getProperty("user.dir") + "/src/test/resources/logback.xml");
    }
