...
properties([
      parameters([
           ...
           choice(name: 'jenkinsAgentLabelName', choices: ['solstice_art-int01_slave','solstice_art-int02_slave','solstice-art-int02-windows-slave','solstice_art-int03_slave','cimcdhdev','cimcdhogg','cimcdhogg2','solstice_xtest01_slave','solstice_xtest02_windows_slave','solstice_xtest02_slave','solstice_xtest03_slave','solstice_mig01_slave','cimcdhxtest14','cimcdhartint04'], description: 'Jenkins Agent label name'),
...
/* DEFINING JENKINS AGENT (Mandatory step)*/
	agent{label "${jenkinsAgentLabelName}"}
...
/* STAGES STARTS */
    stages{
        ...
        /* STAGE TO SET JDK PATH STARTS*/
		//    stage('Set JDK Path'){
		//	    steps{
			    /**
                 * This method has implementation to set Java Home path for Agent passed
                 *
                 * @param jenkinsAgentLabelName - its the jenkins agent name / slave name
                 * @return the Java Home path for passed jenkins agent
                 */
		//		 setJDKPath(jenkinsAgentLabelName)
		//	}
		//}
		/* STAGE TO SET JDK PATH ENDS*/
        ...
        stage('Import results to Xray') {
            steps {
                /**
                  ...
                  * @param TestType - its the TestTag that needs to be executed
                  * @param EnvironmentName - environment name on which tests needs to be executed
                  * @param isParallelExecute (optional)- to define whether test execution will be parallel or not
                  * @param typeOfParallelExecution (optional) - to define the which parallel execution profile will be used
                  * @param threadOrForkCount (optional) - to define the thread's or fork's count for parallel execution
                  *                                       Exclude the optional parameters if not required
                  */
